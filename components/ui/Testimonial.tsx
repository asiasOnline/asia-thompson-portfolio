...
const Testimonial: React.FC<TestimonialProps> = ({i, providerName, avatarSrc, alt, role, company, testimonialText}) => {
  return (
    <div className='h-screen sticky top-0 flex items-center justify-center'>
      <div className='w-3/5 h-[500px] relative origin-top flex flex-col items-center justify-center gap-8 border border-black bg-white rounded-lg px-14 py-14' style={{top:`calc(-5vh + ${i * 24}px)`}}>
