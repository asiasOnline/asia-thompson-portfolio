        ...
        <div className='flex bg-white relative border-4 rounded-2xl border-black/10 p-12 dark:bg-black dark:border-white/10'>
            <div className="flex flex-col gap-6">
                <div className='flex items-center gap-6'>
                    <h2 className='text-2xl font-bold text-transparent bg-gradient-to-r from-fountainBlue via-ultramarine to-steelPink bg-clip-text dark:from-fountainBlue dark:via-slateBlue dark:to-steelPink'>{title}</h2>
                    <p className='text-xs'>0{id}</p>
                </div>
                <p className='pr-40'>{description} </p>
            </div>
