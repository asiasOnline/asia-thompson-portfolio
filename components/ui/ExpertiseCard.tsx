...
export const ExpertiseCard: React.FC<ExpertiseCardProps> = ({id, title, description, tools}) => {
  return (
    <div className="relative group">
        ...
        '/>
        <div className='min-w-[420px] h-auto min-h-[400px] p-6 md:py-8 flex flex-col md:place-items-center md:justify-between gap-6 lg:gap-4 bg-white relative border rounded-2xl border-black dark:bg-black dark:border-white/10 hover:border-black/5 hover:shadow-none'>
            ...
            <ExpertiseTools className="flex flex-row items-center place-content-center lg:justify-center md:mt-0 lg:min-w-96" tools={tools}/>
        </div>
    </div>
  )
}
