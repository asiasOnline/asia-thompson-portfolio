...
const Testimonials = () => {
  return (
    <div>
        <div className='px-8 md:px-16 lg:px-24 xl:px-28 2xl:px-32'>
            <h3 className='text-6xl mb-10'>What Others Say About My Work</h3>
            <div className='w-full flex justify-center'>
              <div className='w-3/5 flex border border-black rounded-md p-14'>
